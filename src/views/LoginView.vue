  ...
  <div>
    <CardUI>
      <div class="flex flex-col gap-8 items-center justify-center">
        <h1 class="text-2xl border-b-2">{{ t('login.title') }}</h1>
        <Form :validation-schema="schema" @submit="handleSubmit" class="flex flex-col">
          <div class="flex items-center gap-2 mb-4">
            <label for="email" class="w-1/3">{{ t('login.email') }}:</label>
          ...
          <div class="flex items-center gap-2 mb-4">
            <label for="password" class="w-1/3">{{ t('login.password') }}:</label>
            <div class="flex flex-col">
              <Field
                name="password"
                type="password"
          ...
          >
            <span class="text-red-500">{{ t('login.invalid') }}</span>
          </div>
